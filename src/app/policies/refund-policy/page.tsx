  ...
  return (
    <main className="px-10 sm:px-32 md:px-52 py-8 text-zinc-600">
      ...
      <p>
        ...
        surgir situaciones inesperadas. A continuación, detallamos nuestras
        políticas de devoluciones y reembolsos para garantizar una experiencia
        ...
        independiente. Por favor, comunícate con nosotros escribiendo a
