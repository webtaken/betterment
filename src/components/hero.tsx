  ...
  return (
    <div className="relative overflow-hidden">
      <div className="grid grid-cols-12">
        <section className="col-span-12 md:col-start-1 md:col-span-12 lg:col-start-1 lg:col-span-12 2xl:col-start-2 2xl:col-span-10 flex relative max-[450px]:h-[510px] min-[451px]:h-[550px] min-[535px]:h-[620px] sm:h-[390px] md:h-[540px]">
      ...
      <div className="relative max-[540px]:-top-6 -top-10 sm:-top-10 md:-top-8 bg-primary rounded-full flex items-center gap-4 justify-center w-fit md:w-[650px] mx-auto px-4 py-1 md:py-3 z-50 text-sm md:text-base lg:text-base">
